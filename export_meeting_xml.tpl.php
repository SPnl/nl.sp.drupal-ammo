...
<amendment_id_text>Wijzigingsvoorstel nr. <?php print $chapter['chapter_nr'] . '.' . $amendment['chapterized_id']; ?> (hoofdstuk <?php print $amendment['chapter']; ?> pagina <?php print $amendment['page']; ?> regel <?php print $amendment['line']; ?>)</amendment_id_text>
<?php $list = array(); ?>
